...
- Addressed Preflight findings by updating Unit 1 in `tasks.md` with explicit `package-lock.json` clean-tree generation/verification and `.gitignore` coverage ignore assertions.
